...
Compo.compos_boundary_smooth(uicompos)
Compo.compos_boundary_flatten(uicompos)
draw.draw_boundary(uicompos, org.shape, 'boundary', window_name='smooth', show=True)
...
for compo in uicompos:
    cnt = compo.boundary_1d
    cv2.drawContours(drawing, [cnt], 0, (rint(0,255), rint(0,255), rint(0,255)))
