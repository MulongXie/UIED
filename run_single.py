...
if __name__ == '__main__':
    ...
    input_path_img = '/public/dataset/UEyes/UEyes_dataset/images/0bce2b.png'
    output_root = './output'
    key_params = key_params_dic['poster']
    ...
    if is_ocr:
        ...
        text.text_detection(input_path_img, output_root, show=False, method='paddle',paddle_model=paddle_model)
